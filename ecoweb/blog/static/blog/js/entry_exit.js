...
document.getElementById('search-button').addEventListener('click', function () {
    ...
    fetch(`${API_BASE_URL}/api/entry_exit/`, {
        ...
        body: JSON.stringify({ stockCode: stockCode, startDate: startDate, endDate: endDate, strategy: strategy })
    })
        ...
        .then(data => {
            if (data.success) {
                ...
                renderChart(chartData, strategy);
            } else {
